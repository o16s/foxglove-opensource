...
export const openDialog: Partial<TypeOptions["resources"]["openDialog"]> = {
  ...
  collaborateTitle: "使用 octaview 数据平台加速开发",
  ...
  learnMore: "了解更多",
  needHelp: "需要帮助？",
  needHelpDescription: "查看我们的文档，或查看 octaview 博客上的教程。",
  newToFoxgloveStudio: "第一次使用 octaview Studio？",
  ...
  shareLayouts: "分享布局",
  signIn: "登录",
  startCollaborating: "与您的 octaview 组织开始合作",
  startCollaboratingDescription:
    "充分利用你的 octaview 账户——无论你想深入研究你的数据还是与你的团队成员分享工具。",
